...
|---|---|---|---|---|---|
| convnext_tiny | 0.768±0.029 | 0.913±0.008 | 0.956±0.019 | 0.656±0.562 | 0.973±0.007 |
...
| arch | N=1 | N=2 | N=3 | N=4 | N=full |
|---|---|---|---|---|---|
| convnext_tiny | 0.916±0.009 | 0.969±0.004 | 0.987±0.003 | 0.666±0.562 | 0.991±0.002 |
...
| arch | N=1 | N=2 | N=3 | N=4 | N=full |
|---|---|---|---|---|---|
| convnext_tiny | 0.710±0.039 | 0.888±0.009 | 0.942±0.025 | 0.649±0.562 | 0.964±0.009 |
...
| arch | N=1 | N=2 | N=3 | N=4 | N=full |
|---|---|---|---|---|---|
| convnext_tiny | 0.258±0.004 | 0.355±0.007 | 0.407±0.007 | 0.331±0.253 | 0.453±0.007 |
...
|---|---|---|---|
| convnext_tiny | 28056980.000 | 25.807 | 713.433 |
